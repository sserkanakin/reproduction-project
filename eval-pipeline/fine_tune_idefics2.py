...
class CustomDataCollator:
    def __init__(self, processor: AutoProcessor, image_base_path: str):
    ...
    def __call__(self, examples: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]:
        ...
        batch = self.processor(text=texts, images=images_batch, return_tensors="pt", padding=True)
...
def main(args):
    ...
    model = Idefics2ForConditionalGeneration.from_pretrained(args.model_id, torch_dtype=torch.bfloat16, device_map="auto")
    ...
    training_args = TrainingArguments(
        ...
        weight_decay=0.01,
        logging_dir=f"{args.output_dir}/logs", logging_strategy="steps", logging_steps=10,
        # eval_strategy="epoch", eval_steps=50,
        # save_strategy="epoch", save_steps=50,
